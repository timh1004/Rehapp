...
func == (lhs: SensorData, rhs: SensorData) -> Bool {
    return (lhs.sensorTimeStampInMilliseconds == rhs.sensorTimeStampInMilliseconds && lhs.sensor1Force == rhs.sensor1Force && lhs.sensor2Force == rhs.sensor2Force && lhs.sensor3Force == rhs.sensor3Force)
}
