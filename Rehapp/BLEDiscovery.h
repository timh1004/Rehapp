...
@property (nonatomic, retain) NSMutableArray *supportedServiceUUIDs;
@property (nonatomic, retain) NSMutableArray *supportedCharacteristicUUIDs;
...
@property (nonatomic, retain) NSMutableArray *connectedServices;
